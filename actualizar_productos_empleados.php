				...
				<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
					...
					<div class="modal-body">	
						...
						<div class="form-group" id="caja">
							...
							<input type="text" class="form-control" value="<?php echo $ser ?>" name="serial" id="serial" required>
						</div>
						<div class="form-group" >
							<label>CODIGO</label>
					...
					<div class="modal-footer">
						<a href="productos_empleados.php"><input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar"></a>
