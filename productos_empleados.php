<?php
	require ('paginacion_productos_empleados.php');
	require ('registros_productos_empleados.php');
...
?>
                ...
                <tbody>
				    ...
				    <!--<td><?php /*if($personas->USUARIO_ID==1){
							...
							?></td>-->
                        <td>
                            <a href="actualizar_productos_empleados.php?id=<?php echo $personas->ID_PRODUCTOS ?> & nom=<?php echo $personas->NOMBRE ?> & ser=<?php echo $personas->CANTIDAD ?> & bie=<?php echo $personas->CODIGO ?> & mar=<?php echo $personas->FECHA ?> & mod=<?php echo $personas->PROVEEDOR ?>" class="edit" data-toggle="modal"><i class="icon-pencil" data-toggle="tooltip" title="Editar"></i></a>
			...
			<div class="modal-content">
				<form >
					...
					<div class="modal-footer">
						...
						<a href="borrar_productos_empleados.php?iD=<?php echo $personas->ID_PRODUCTOS ?>">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group ">
							...
							<input type="number" class="form-control" name="inser_ser">
						</div>
						<div class="form-group">
							<label>CODIGO</label>
