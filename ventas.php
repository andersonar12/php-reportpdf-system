<?php
	require ('paginacion_ventas.php');
	require ('registros_ventas.php');
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
				...
				<div class="row">
					<div class="col mt-3">
						<a href="reportes_pdf/funciones/reportes_ventas.php" target="_blank" class="btn btn-success"><i class="icon-eye" ></i> <span>Imprimir PDF</span></a>				
					</div>
				</div>
            </div>
...
?>
                ...
                <tbody>
				    ...
				    <!--<td><?php /*if($personas->USUARIO_ID==1){
							...
							?></td>-->
                        <td>
                            <a href="actualizar_ventas.php?id=<?php echo $personas->ID_VENTA ?> & nom=<?php echo $personas->NOMBRE_VENDEDOR ?> & ser=<?php echo $personas->NOMBRE_CLIENTE ?> & bie=<?php echo $personas->FECHA_VENTA ?> & mar=<?php echo $personas->NOMBRE ?> & mod=<?php echo $personas->CODIGO_PRODUCTO ?> & est=<?php echo $personas->MONTO_VENTA ?>" class="edit" data-toggle="modal"><i class="icon-pencil" data-toggle="tooltip" title="Editar"></i></a>
			...
			<div class="modal-content">
				<form >
					...
					<div class="modal-footer">
						...
						<a href="borrar_ventas.php?iD=<?php echo $personas->ID_VENTA ?>">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" name="inser_bie" required>
						</div>
						<div class="form-group">
