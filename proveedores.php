<?php
	...
	require ('registros_proveedores.php');
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
				...
				<div class="row">
					<div class="col mt-3">
						<a href="reportes_pdf/funciones/reportes_proveedores.php" target="_blank" class="btn btn-success"><i class="icon-eye" ></i> <span>Imprimir PDF</span></a>				
					</div>
				</div>
            </div>
...
?>
                ...
                <tbody>
				    ...
				    <!--<td><?php /*if($personas->USUARIO_ID==1){
							...
							?></td>-->
                        <td>
                            <a href="actualizar_proveedores.php?id=<?php echo $personas->ID_PROVEEDORA ?> & nom=<?php echo $personas->NOMBRE ?> & ser=<?php echo $personas->DESCRIPCION ?> & bie=<?php echo $personas->CORREO ?> & mar=<?php echo $personas->RIT ?> & mod=<?php echo $personas->TELEFONO ?>" class="edit" data-toggle="modal"><i class="icon-pencil" data-toggle="tooltip" title="Editar"></i></a>
					
                            <a data-target="#deleteEmployeeModal<?php echo $personas->ID_PROVEEDORA ?>" class="delete" id="delete" data-toggle="modal"><i class="icon-trash-o" data-toggle="tooltip" title="Borrar"></i></a>
					   
                        </td>
                    </tr>
                </tbody>
			 <!-- Delete Modal HTML -->
	<div id="deleteEmployeeModal<?php echo $personas->ID_PROVEEDORA ?>" class="modal fade">
			...
			<div class="modal-content">
				<form >
					...
					<div class="modal-footer">
						...
						<a href="borrar_proveedores.php?iD=<?php echo $personas->ID_PROVEEDORA ?>">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group ">
							...
							<input type="text" class="form-control" name="inser_ser" required>
						</div>
						<div class="form-group">
							<label>CORREO</label>
							<input type="email" class="form-control" name="inser_bie" required>
						</div>
						<div class="form-group">
							<label>RIT</label>
							<input type="text" class="form-control" name="inser_mar" required>
						</div>
						<div class="form-group">
							<label>TELEFONO</label>
							<input type="number" class="form-control" name="inser_mod" required>
						</div>
