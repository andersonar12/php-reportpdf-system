<?php
	...
	require ('registros_usuarios.php');
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
				...
				<div class="row">
					<div class="col mt-3">
						<a href="reportes_pdf/funciones/reportes_usuarios.php" target="_blank" class="btn btn-success"><i class="icon-eye" ></i> <span>Imprimir PDF</span></a>				
					</div>
				</div>
            </div>
...
?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $personas->ID_USUARIO ?></td>
				    <td></td>
                        <td><?php echo $personas->NOMBRE ?></td>
                        <td><?php echo $personas->ROL_ID ?></td>
				    ...
				    <!--<td><?php /*if($personas->USUARIO_ID==1){
                        ...
                        <td>
                            ...
                            <a data-target="#deleteEmployeeModal<?php echo $personas->ID_USUARIO ?>" class="delete" id="delete" data-toggle="modal"><i class="icon-trash-o" data-toggle="tooltip" title="Borrar"></i></a>
					   
                        </td>
                    </tr>
                </tbody>
			 <!-- Delete Modal HTML -->
	<div id="deleteEmployeeModal<?php echo $personas->ID_USUARIO ?>" class="modal fade">
			...
			<div class="modal-content">
				<form >
					...
					<div class="modal-footer">
						...
						<a href="borrar_usuarios.php?iD=<?php echo $personas->ID_USUARIO ?>">
			...
			<div class="modal-content">
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>ROL</label>
							<select class="form-control" name="inser_est" id="est" required>
