<?php
     ...
     if(!isset($_POST['bot_actualizar'])){
          ...
          $sql = "UPDATE USUARIOS SET ROL_ID=:miBie WHERE ID_USUARIO=:miId";
			...
			<div class="modal-content">
				<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
					...
					<div class="modal-body">	
						...
						<div class="form-group">
							<label>NOMBRE</label>
							<input type="text" class="form-control" value="<?php echo $nom ?>" name="nombre" readonly>
						</div>
						<div class="form-group" id="caja">
							<label>ROL_ID</label>
							<select class="form-control" name="bien" id="" require>
					...
					<div class="modal-footer">
						<a href="usuarios.php"><input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar"></a>
